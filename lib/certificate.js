...
function buildCertificateHTML(data) {
  ...
  return (
    '<div style="position:relative;width:1536px;height:1024px;font-family:Arial,sans-serif;">' +

    '<img id="cert-bg-img" src="' + origin + '/certificate-template.jpg.png" style="position:absolute;top:0;left:0;width:1536px;height:1024px;display:block;" crossorigin="anonymous" />' +
