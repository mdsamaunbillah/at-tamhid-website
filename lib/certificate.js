...
function buildCertificateHTML(data) {
  ...
  return (
    ...
    '<img id="cert-bg-img" src="' + origin + '/certificate-template.jpg" style="position:absolute;top:0;left:0;width:1536px;height:1024px;display:block;" crossorigin="anonymous" />' +
